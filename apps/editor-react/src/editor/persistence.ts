import { createEmptyProject, parseSpriteProject, serializeSpriteProject } from "../../../../shared/ast";
import {
  DEFAULT_GRID_SIZE,
...
export function readPersistedEditorState(storage: Storage | null = globalThis.localStorage ?? null) {
...
export function writePersistedPayload(
  storage: Storage,
  payload: string,
  slot: 0 | 1
): 0 | 1 {
